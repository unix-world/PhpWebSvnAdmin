...
//--
// INSTALLATION: copy this file from config.sample.php to config.php, then edit it to match your needs
//--
...
$config->setSVNCommandPath('/usr/local/bin/'); //  e.g. c:\\program files\\subversion\\bin
...
$config->setZipPath('/usr/local/bin/');
...
//$config->addRepository('NameToDisplay 1', 'file:///REPO/some-repo-2');
//$config->addRepositorySubPath('NameToDisplay 2', 'http://svn.local/svn/some-repo-2/', null, null, 'user', 'pass');
//$config->addRepositorySubPath('NameToDisplay 3', 'http://svn.local/svn/some-repo-3/', 'trunk', null, 'user', 'pass');
...
//$config->addTemplatePath('templates/calm/');
...
$config->setDefaultFolderDlMode('zip');
//
